...
featureBatch, labelBatch = inputPipeLine(['train.csv'], batchSize = 2)
...
#     batch_x, batch_y = inputPipeLine(['train.csv'],batchSize = BATCH_SIZE)
#     sess = tf.Session()
...
#         feed_dict = {model.xs:batch_x, model.ys:batch_y}
